                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody id="myTable">
                                        ...
                                        <?php
                                            ...
                                            <td scope="col" class="" id="mylayout_2" ><a href="pipeline_view.php?id=<?php echo $res_search["pip_id"]; ?>"><?php echo $res_search["project_name"]; ?> |<span class='badge badge-primary'>Customer : <?php echo $res_search["contact_fullname"]; ?></span> | <span class='badge badge-warning'><?php echo number_format( $res_search["pip_salen"], 0 ) ; ?> บาท</span></a></td>
