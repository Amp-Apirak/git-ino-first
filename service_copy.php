...
<head>
    ...
    <title>INO | Copy Service Pattern</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Copy Service Pattern</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">Copy Service Pattern</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            ...
                            <!-- /.form-group -->
                             ...
                             <?php
                                $contact_fullname = "";
                                $_sql_contact = "SELECT DISTINCT * FROM contact ORDER BY pipeline.pip_id desc";
