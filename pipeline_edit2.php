                                        ...
                                        <div class="row">
                                            <div class="col col">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="int" name="pip_sale" class="form-control"  onkeyup="sum();" value="<?= $r->pip_salen; ?>"
                                                        id="pip_sale"  require > 
                                                </div>

                                                <div class="form-group">
                                                    <label>Sales (No Vat)<span class="text-danger">*</span></label>
                                                    <input type="int" name="pip_salen" id="pip_salen" readonly="readonly" onkeyup="sum();"  value="<?= $r->pip_salen; ?>"
                                                        class="form-control"  style="background-color:#F8F8FF" placeholder="">      
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label>Cost (No Vat)</label>
                                                    <input type="int" name="pip_costn" id="pip_costn"  class="form-control" onkeyup="sum();" value="<?= $r->pip_costn; ?>"
                                                        placeholder="ระบุราคาต้นทุนโครงการ" >
                                                </div>
                                                <div class="form-group">
                                                    <label>Cost (Vat)</label>
                                                    <input type="int" name="pip_cost" class="form-control"  onkeyup="sum();" value="<?= $r->pip_cost; ?>"
                                                        id="pip_cost" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="int" name="pip_gp" class="form-control"  onkeyup="sum();" value="<?= $r->pip_gp; ?>"
                                                        id="pip_gp" 
                                                ...
                                                <div class="form-group">
                                                    <label>GP (%)</label>
                                                    <input type="int" name="pip_gp2" class="form-control"  onkeyup="sum();" value="<?= $r->pip_gp2; ?>"
                                                        id="pip_gp2" 
