                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        if (isset($_POST['submit'])) { /* ถ้า POST มีการกด Submit ให้ทำส่วนล่าง */
                            ...
                            `file_upfile` = '$file_upfile', `file_link` = '$file_link' WHERE files_id=" . $_GET['files_id'];
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label"
                                                        for="customFile"><?= $r->file_upfile; ?></label>

                                                    <input type="hidden" class="form-control " id="upfile1"
                                                        name="upfile1" value="<?= $r->file_upfile; ?>">
                                                </div>
                                            </div>
                                            <!-- /.form-group -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="file_status" class="form-control"
                                                    id="exampleInputEmail1" value="<?= $r->file_status; ?>"
                                                    placeholder="">
                                            </div>
                                            <!-- /.form-group -->
