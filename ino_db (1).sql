...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2023 at 06:11 PM
...
(6, 'ระบบเฝ้าระวังเหตุฉุกเฉิน และเฝ้าระวังค่าสุขภาพทางไกล', 'KYD', 'Emergency Platform', '7', 500000, 535000, 300000, 321000, 200000, 40, '100', 10, 'ระบบเฝ้าระวังเหตุฉุกเฉิน และเฝ้าระวังค่าสุขภาพทางไกลโดย เจ้าหน้าที่ประจำศูนย์command centerเทศบาลนครรังสิต  POC อุปกรณ์จำนวน 15 ตัว ระยะเวลา 01-04-56 ถึง 30-09-56 \r\n', '2023-09-01 16:10:06', 'Apirak bangpuk', 500000, 300000, 200000, '2023-05-01', '2023-09-30', 'On Process', 'TH20230501'),
(7, 'ระบบเฝ้าระวังเหตุฉุกเฉิน และเฝ้าระวังค่าสุขภาพทางไกล', 'KYD', 'Emergency Platform', '7', 500000, 535000, 300000, 321000, 200000, 40, '100', 10, 'ระบบเฝ้าระวังเหตุฉุกเฉิน และเฝ้าระวังค่าสุขภาพทางไกลโดย เจ้าหน้าที่ประจำศูนย์command centerเทศบาลนครรังสิต  POC อุปกรณ์จำนวน 15 ตัว ระยะเวลา 01-04-56 ถึง 30-09-56 \r\n', '2023-09-01 15:59:58', 'Apirak bangpuk', 500000, 300000, 200000, '2023-05-01', '2023-09-30', 'On Process', 'TH20230501'),
...
--
ALTER TABLE `contact`
  MODIFY `contact_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=11;
...
--
ALTER TABLE `pipeline`
  MODIFY `pip_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'เลขไอดีของ Project', AUTO_INCREMENT=9;
